...
const dispatch = useDispatch()
  ...
  onChange={change}
              ...
              <div className="text-right">
                <a href="#" className="text-sm text-purple-500 hover:text-purple-600 font-medium">
                  Forgot your password?
                </a>
              </div>

              {/* Login Button */}
              <button  onSubmit={submit} className="w-full bg-gradient-to-r from-purple-500 to-blue-500 text-white py-3 rounded-lg hover:opacity-90 transition-opacity duration-200 flex items-center justify-center space-x-2 group">
                <span>Log In</span>
